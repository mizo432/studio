...
import jp.or.venuspj.image.core.model.ImageClipRectangle;
import jp.or.venuspj.image.core.model.ImageCodec;
import jp.or.venuspj.image.core.model.ScaleType;
...
public class ImageUtils {
    ...
    public static ImageCodec getImageCodec(ConnectionStream connectionStream) {
        if (connectionStream != null &&
            ...
            if (Strings2.isNotEmpty(contentType)) {
    ...
    public static ScaleType getScaleType(String scaleTypeStr) {
        ...
        if (Strings2.isNotEmpty(scaleTypeStr)) {
