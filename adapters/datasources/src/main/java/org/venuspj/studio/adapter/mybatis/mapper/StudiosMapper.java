...
import org.venuspj.studio.adapter.mybatis.model.StudiosExample;
...
public interface StudiosMapper {
     ...
     * @mbg.generated
     */
    List<Studios> selectByExampleWithBLOBs(StudiosExample example);
     ...
     * @mbg.generated
     */
    List<Studios> selectByExample(StudiosExample example);
