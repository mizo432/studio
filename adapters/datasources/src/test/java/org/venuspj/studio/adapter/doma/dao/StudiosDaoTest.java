 ...
 * 
 */
public class StudiosDaoTest extends TestCase {
    ...
    public void testSelectById() throws Exception {
        SqlFile sqlFile = repository.getSqlFile(getMethod(), "META-INF/org/venuspj/studio/adapter/doma/dao/StudiosDao/selectById.sql", dialect);
        execute(sqlFile);
    }
