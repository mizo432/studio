 ...
 *
 */
public class StudioPlayerXMembersDaoTest extends TestCase {
    ...
    public void testSelectById() throws Exception {
        SqlFile sqlFile = repository.getSqlFile(getMethod(), "META-INF/org/venuspj/studio/adapter/doma/dao/StudioPlayerXMembersDao/selectById.sql", dialect);
        execute(sqlFile);
    }
